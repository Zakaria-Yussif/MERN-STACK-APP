...
/>
                ...
                <div className="reset">
                    <a  onClick={toggleReset}  target='_blank' >Forget Password/Reset Password</a>
        ...
        <form  className="SignUp_Form" onSubmit={handleSignUp}>
         <h2  className="headerLogin1" style={{fontSize:"21px", }}> SignUp </h2> 
               <div className='input_el'>
               <label htmlFor="input-3">Full Name</label>
                ...
                <input id="checkbox" type="checkbox" required/> <a  > <span id="span1" style={{color:"white"}}>Terms & Conditions</span> </a>
          </div>
              ...
              {!isFormVisible ?(<span style={{fontSize:"20px", border:"none"}} id="id_create" >SignUp</span>):(<span id="id_create" >Login</span>)} </a></b><br></br>
                <span className="bottom2"><span className="bottom4">Manage cookies</span> & <span className="bottom3">opt out</span></span>
               </div> 

         <div className="login_footer">
               <div className="col-1"><b id="b1">@copyRight||Zack.com</b></div>
